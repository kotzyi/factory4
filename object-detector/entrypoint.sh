...
python /home/detector/scripts/pre-processing/generate_tfrecord.py -x $TRAIN_IMAGE_PATH -l $TRAIN_IMAGE_LABEL_PATH -o $TRAIN_IMAGE_TFRECORD_PATH

echo "CREATE TEST TFRECORD"
python /home/detector/scripts/pre-processing/generate_tfrecord.py -x $TEST_IMAGE_PATH -l $TEST_IMAGE_LABEL_PATH -o $TEST_IMAGE_TFRECORD_PATH
